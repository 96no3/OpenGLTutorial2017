 ...
 *  File Size        : 320,704 bytes
 *  Date Time        : 2017/08/02 3:08
 *  Target           : Public
 *  Cues             : 8
 *  CueSheet Comment : 
...
#define CRI_SAMPLECUESHEET_CUENUM (8)
...
/* Cue List (Cue ID) */
#define CRI_SAMPLECUESHEET_PLAYERSHOT   ( 0) /*   */
#define CRI_SAMPLECUESHEET_START        ( 1) /*   */
...
#define CRI_SAMPLECUESHEET_AFTERBURNER  ( 7) /*   */
